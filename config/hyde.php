...
return [
    ...
    */
    ...
    'name' => env('SITE_NAME', 'Chessarama Codex'),
    ...
    */
    ...
    'rss' => [
        ...
        'description' => env('SITE_NAME', 'Chessarama Codex').' RSS Feed',
    ],
    ...
    */
    ...
    'meta' => [
        Meta::name('author', 'Minimol Games'),
        ...
        Meta::property('site_name', env('SITE_NAME', 'Chessarama Codex')),
    ],
    ...
    */
    ...
    'authors' => [
        Author::create(
            'fanzorena-minimol', // Required username
            'Minimol Games', // Optional display name
            'https://minimolgames.com' // Optional website URL
        ),
    ],
